...
export const ROIChart = ({ period = "QTD" }: ROIChartProps) => {
  ...
  const periodLabel = period === "QTD" ? "Q2 2026 · return on opening balance" : "Q1 + Q2 2026 · return on initial deposit";
  return (
      ...
      <Card className="p-6 bg-card border-border">
        ...
        <ResponsiveContainer width="100%" height={320}>
          <LineChart data={data} margin={{ top: 10, right: 20, left: 0, bottom: 10 }}>
            ...
            <Line type="monotone" dataKey="roi" stroke="hsl(var(--success))" strokeWidth={2.5}
              dot={{ fill: "hsl(var(--success))", strokeWidth: 0, r: 5 }} activeDot={{ r: 7 }}
